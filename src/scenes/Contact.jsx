      ...
      <div className="md:flex md:justify-between gap-16 mt-5">
        ...
        >
          <form
            target="_blank"
            onSubmit={onSubmit}
            action="https://formsubmit.co/andrei.duduman123@gmail.com"
            method="POST"
          >
            <input
            ...
            <button
              className="p-5 bg-gradient-gold font-semibold text-green mt-5 hover:bg-hover-gradient-gold hover:text-white transition duration-500"
              type="submit"
            >
              SEND ME A MESSAGE
            </button>
